...
GBA_IWRAM_DATA fpac_t zero_fac = { 0, 0 };
GBA_IWRAM_DATA fpac_t one_fac = { 1, 0 };
GBA_IWRAM_DATA fpac_t fround_fac = { (1u << (FP_V_FROUND + 32)), 0 };
GBA_IWRAM_DATA fpac_t fround_guard_fac = { 0, (1u << (FP_V_FROUND + FP_GUARD)) };
GBA_IWRAM_DATA fpac_t dround_guard_fac = { (1u << (FP_V_DROUND + FP_GUARD)), 0 };
GBA_IWRAM_DATA fpac_t fmask_fac = { 0xFFFFFFFF, (1u << (FP_V_HB + FP_GUARD + 1)) - 1 };
GBA_IWRAM_DATA GAMEBOY_STATIC /*const*/ unsigned int32 and_mask[33] = { 0,
	0x1, 0x3, 0x7, 0xF,
	0x1F, 0x3F, 0x7F, 0xFF,
...
GBA_IWRAM_DATA int32 backup_PC;
...
GAMEBOY_STATIC const unsigned int32 i_limit[2][2] =
...
#ifdef GAMEBOY
const int32 test_code[] = { 0, 0, 0, FPS_IC, FPS_IV, FPS_IU, FPS_IUV };
#endif
